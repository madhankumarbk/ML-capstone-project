...
class Critic:
    ...
    def build_model(self):
        ...
        net_actions = layers.Dense(units=400, kernel_regularizer=regularizers.l2(0.01))(actions)
        net_actions = layers.BatchNormalization()(net_actions)
        net_actions = layers.Activation('relu')(net_actions)
        
        net_actions = layers.Dense(units=300,kernel_regularizer=regularizers.l2(0.01))(net_actions)
        net_actions = layers.BatchNormalization()(net_actions)
        net_actions = layers.Activation('relu')(net_actions)
